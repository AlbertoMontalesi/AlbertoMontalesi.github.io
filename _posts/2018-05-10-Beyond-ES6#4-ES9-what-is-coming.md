---
title: "JavaScript beyond ES6#4 - ES9: what's coming?"
categories:
  - JavaScript
tags:
  - programming
...
Now we can use the rest/spread syntax for object, let's look at how:
...
// we use the ret operator to grab everything else left in the object.
let { a, b, ...z } = myObj;
console.log(a);      // 1
console.log(b);      // 3
console.log(z);   // {c: 5, d: 8}

// using the spreada syntax we cloned our Object 
let clone = { ...myObj };
console.log(clone);
// {a: 1, b: 3, c: 5, d: 8}
```
